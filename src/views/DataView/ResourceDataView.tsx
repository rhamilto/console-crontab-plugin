...
import {
  useResourceDataViewData,
  GetDataViewRows,
} from "./useResourceDataViewData";
...
>({
  ...
  const { filters, onSetFilters, clearAllFilters, filteredData } =
    useResourceDataViewFilters<TData, TFilters>({
      data,
      initialFilters,
      matchesAdditionalFilters,
    });
            ...
            <ResponsiveActions breakpoint="lg">
              <ResponsiveAction
                ...
                onClick={() =>
                  ...
                  //   noLimit: true,
                  // })
                  console.log("createColumnManagementModal")
                }
                aria-label={t("public~Column management")}
                data-test="manage-columns"
              >
                <Tooltip
                  content={t("public~Manage columns")}
                  trigger="mouseenter"
                >
                  <ColumnsIcon />
                </Tooltip>
